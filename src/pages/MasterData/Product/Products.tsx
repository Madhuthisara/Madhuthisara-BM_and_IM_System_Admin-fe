...
import {
    ...
    InputNumber, message, Badge, Divider, Empty, Dropdown, MenuProps, Upload, UploadFile
} from 'antd';
import {
...
const Products: React.FC = () => {
    ...
    const products = productsResponse?.output || [];
    const categories = categoriesResponse?.output || [];
    const templates = templatesResponse?.output || [];
