...
export const productService = {
    getAllProducts: async (businessId: string, config?: AxiosRequestConfig): Promise<ProductsListResponse> => {
        const response = await axiosInstance.get(`${API_ENDPOINTS.PRODUCTS.ALL}?business_id=${businessId}`, config);
